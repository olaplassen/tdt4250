 ...
 * @generated
 */
public class MyEcoreSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MyEcorePackage.PROGRAM_WITH_SPECIALISATION: {
				ProgramWithSpecialisation programWithSpecialisation = (ProgramWithSpecialisation)theEObject;
				T result = caseProgramWithSpecialisation(programWithSpecialisation);
				if (result == null) result = caseProgram(programWithSpecialisation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case MyEcorePackage.SELECTED_SEMESTER: {
				SelectedSemester selectedSemester = (SelectedSemester)theEObject;
				T result = caseSelectedSemester(selectedSemester);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Program With Specialisation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Program With Specialisation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProgramWithSpecialisation(ProgramWithSpecialisation object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Selected Semester</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Selected Semester</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSelectedSemester(SelectedSemester object) {
		return null;
	}
